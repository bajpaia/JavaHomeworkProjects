...
/*
Implement your own MyHashMap<K, V> implements Map<K, V>.
To do that you will also need to implement a class of pairs Element<K, V>.
Use array for buckets and LinkedList<Element> to handle collisions.
Let me know if you are having difficulties implementing your own hash function.
*/
...
//    {
//    	Iterator<LinkedList<Element<K, V>>> iterator = map.iterator();
//        while(iterator.hasNext())
//        {
//            LinkedList<Element<K, V>> listEntries = iterator.next();
//            for (Element<K, V> entry : listEntries) 
//      		{
